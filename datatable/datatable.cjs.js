...
var script$9 = {
    ...
    methods: {
        ...
        onOverlayEnter() {
            ...
            OverlayEventBus__default['default'].on('overlay-click', e => {
        ...
        onOverlayHide() {
            ...
            this.overlay = null;
            OverlayEventBus__default['default'].off('overlay-click');
        },
        overlayRef(el) {
            this.overlay = el;
        },
...
var script$4 = {
    ...
    methods: {
        ...
        switchCellToViewMode() {
            ...
            OverlayEventBus__default['default'].off('overlay-click', this.eventBusKey);
        },
        onClick(event) {
