...
const _hoisted_2 = /*#__PURE__*/vue.createVNode("span", { class: "p-cascadeselect-trigger-icon pi pi-chevron-down" }, null, -1);
const _hoisted_3 = { class: "p-cascadeselect-items-wrapper" };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    (vue.openBlock(), vue.createBlock(vue.Teleport, { to: $props.appendTo }, [
